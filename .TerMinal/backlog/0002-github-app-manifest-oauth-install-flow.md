...
acceptance:
  ...
  - "Once the App exists, a PR is opened with its installation token in a scratch repo and the resulting workflow_run is recorded in ADR-0006 [8], closing the inference flagged there and in ADR-0002 [5]"
